...
public class AdminController {
    ...
    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody AdminCreateRequest request) {
        try {
            Admin admin = service.create(request);
            return ResponseEntity.ok(service.getResponseById(admin.getId()));
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable String id, @Valid @RequestBody AdminUpdateRequest request) {
        try {
